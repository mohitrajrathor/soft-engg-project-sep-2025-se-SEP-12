<template>
  <div class="d-flex vh-100">
    ...
    <!-- Main Content -->
    <div class="flex-grow-1 d-flex flex-column bg-light ml-[250px]">
      <HeaderBar />
      ...
      <div class="flex justify-center items-start bg-gray-100 min-h-screen py-8 relative  ">
        <div class="bg-white w-11/12 max-w-6xl rounded-2xl shadow-lg p-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <input type="text" v-model="title" placeholder="Segmentation fault when using linked list iterator"
                  class="w-full border border-gray-300 rounded-lg p-2 focus:ring-blue-500 focus:border-blue-500" />
              </div>
              ...
              <div>
                ...
                <textarea v-model="details" rows="4"
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <transition name="slide">
                  <div v-if="showPrompt" class="mt-3 border border-gray-300 rounded-lg bg-gray-50 p-3 overflow-hidden">
                    <textarea v-model="generatedPrompt" rows="5"
          ...
          <div class="flex justify-end items-center gap-3 mt-8">
            <button class="px-4 py-2 rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-100 transition">
              Save Draft
            </button>
            <button @click="handleAskAI"
        ...
        <transition name="fade">
          <div v-if="showAIOverlay" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white w-11/12 max-w-4xl p-8 rounded-2xl shadow-2xl relative">
              <button @click="showAIOverlay = false" class="absolute top-4 right-4 text-gray-500 hover:text-gray-700">
                <i class="bi bi-x-lg"></i>
              </button>
              <h2 class="text-2xl font-semibold text-gray-800 mb-4">AI Response</h2>

              <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 text-gray-700 max-h-[60vh] overflow-y-auto">
                <p class="whitespace-pre-line">{{ aiResponse }}</p>
              </div>

              <div class="text-right mt-6">
                <button @click="sendToInstructor"
