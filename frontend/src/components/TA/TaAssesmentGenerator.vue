<template>
  <div class="flex">
    ...
    <main class="flex-1 flex flex-col min-h-screen ml-[250px] bg-gray-50">
      <!-- Header -->
      <TaHeaderBar searchPlaceholder="Search assessments or courses..." />

      <!-- Page Content -->
      <div
        class="flex justify-center items-start p-8 overflow-auto flex-1"
      >
        <div
        ...
        >
          ...
          <div class="space-y-6">
            ...
            <!-- Marks Allocation -->
            <div>
              <label class="block text-gray-700 font-medium mb-2">Marks per Question</label>
              <input
            ...
            <!-- Number of Questions -->
            <div>
              <label class="block text-gray-700 font-medium mb-2">Total Questions</label>
              <input
            ...
            <!-- Review Mode -->
            <div>
              <label class="block text-gray-700 font-medium mb-2">Review Mode</label>
