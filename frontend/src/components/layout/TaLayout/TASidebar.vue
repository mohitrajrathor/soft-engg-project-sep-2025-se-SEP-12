...
const mainNav = [
  { name: 'Dashboard', path: '/ta/dashboard', icon: 'bi-speedometer2' },
  { name: 'Query Tracker', path: '/ta/query-tracker', icon: 'bi-robot' },
  { name: 'Doubt Summarizer', path: '/ta/doubt-summarizer', icon: 'bi-journal-text' },
